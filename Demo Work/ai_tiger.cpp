...
int main(){
    ...
    for(;;){
        ...
        if(tiger_kill_move_flag==1){
            ai_board[ move_to[0] ] [ move_to[1] ]='T';
            ai_board[ move_from[0] ] [ move_from[1] ]='*';
            ai_board [ (move_to[0] + move_from[0] )/2 ] [ (move_to[1] + move_from[1] )/2 ] = '*';
            ai_killed_goat++;
        ...
        cout<<ai_killed_goat<<endl;
       
        if(value==infinity || ai_killed_goat==5) {
            print_board();
...
void goat_move(){
    ...
    (t1==2 && t2==4)||(t1==3 && t2==1)||(t1==3 && t2==3)|| (t1==4 && t2==0)||(t1==4 && t2==2)||(t1==4 && t2==4)){
        ...
        if(((t1-1==t3)&&(t2==t4))||((t1+1==t3)&&(t2==t4))){
            if(ai_board[t3][t4]=='*') {ai_board[t3][t4]='G';ai_board[t1][t2]='*';g_count--;}
